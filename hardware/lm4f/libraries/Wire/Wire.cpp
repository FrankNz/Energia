...
static const unsigned long g_uli2cMasterBase[4] =
{
    ...
    I2C8_BASE, I2C7_BASE
#else  //error
#error Target for g_uli2cMasterBase NOT defined
#endif
};
...
static const unsigned long g_uli2cInt[4] =
{
    ...
    INT_I2C8, INT_I2C7
#else  //error
#error Target for g_uli2cInt NOT defined
#endif
};
...
#else  //error
#error Target for g_uli2cPeriph NOT defined
#endif
};
...
{
#if defined(TARGET_IS_BLIZZARD_RB1)
    GPIO_PORTB_BASE, GPIO_PORTA_BASE,
    GPIO_PORTE_BASE, GPIO_PORTD_BASE
#elif defined(__TM4C129XNCZAD__)
    GPIO_PORTB_BASE, GPIO_PORTG_BASE,
    GPIO_PORTL_BASE, GPIO_PORTG_BASE
#elif defined(__TM4C1294NCPDT__)
...
static const unsigned long g_uli2cSDAPins[4] =
{
    ...
    GPIO_PIN_3, GPIO_PIN_1
#else  //error
#error Target for g_uli2cSDAPins NOT defined
#endif
};
...
static const unsigned long g_uli2cSCLPins[4] =
{
    ...
    GPIO_PIN_2, GPIO_PIN_0
#else  //error
#error Target for g_uli2cSCLPins NOT defined
#endif
};
